...
export const setPushNotificationTokenAction = (token) => {
          return {
...
export const setAutreNumeroAction = (client) => {
          return {
                    type: SET_AUTRE_NUMERO,
                    payload: client
          }
}
...
export const setErrorsAcion = (errors) => {
          return {
                    type: SET_ERRORS,
                    payload: errors
          }
